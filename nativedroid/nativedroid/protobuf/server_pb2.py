...
# source: nativedroid/protobuf/server.proto
...
_GENSUMMARYREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='so_handle', full_name='nativedroid_server.GenSummaryRequest.so_handle', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='jni_func', full_name='nativedroid_server.GenSummaryRequest.jni_func', index=1,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='method_signature', full_name='nativedroid_server.GenSummaryRequest.method_signature', index=2,
...
_HASSYMBOLREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='so_handle', full_name='nativedroid_server.HasSymbolRequest.so_handle', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_ANALYSENATIVEACTIVITYREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='so_handle', full_name='nativedroid_server.AnalyseNativeActivityRequest.so_handle', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_LOADBINARYRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='so_handle', full_name='nativedroid_server.LoadBinaryResponse.so_handle', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
GenSummaryRequest = _reflection.GeneratedProtocolMessageType('GenSummaryRequest', (_message.Message,), dict(
  ...
  __module__ = 'nativedroid.protobuf.server_pb2'
...
_NATIVEDROIDSERVER = _descriptor.ServiceDescriptor(
  name='NativeDroidServer',
  full_name='nativedroid_server.NativeDroidServer',
  file=DESCRIPTOR,
  index=0,
  options=None,
  ...
  _descriptor.MethodDescriptor(
    name='GenSummary',
    full_name='nativedroid_server.NativeDroidServer.GenSummary',
    index=0,
  ...
  _descriptor.MethodDescriptor(
    name='HasSymbol',
    full_name='nativedroid_server.NativeDroidServer.HasSymbol',
    index=1,
    containing_service=None,
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='nativedroid_server.NativeDroidServer.AnalyseNativeActivity',
    index=2,
    containing_service=None,
  ...
  _descriptor.MethodDescriptor(
    name='LoadBinary',
    full_name='nativedroid_server.NativeDroidServer.LoadBinary',
    index=3,
    containing_service=None,
...
_sym_db.RegisterServiceDescriptor(_NATIVEDROIDSERVER)

DESCRIPTOR.services_by_name['NativeDroidServer'] = _NATIVEDROIDSERVER
