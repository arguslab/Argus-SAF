...
_GENSUMMARYREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='depth', full_name='nativedroid_server.GenSummaryRequest.depth', index=1,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='so_digest', full_name='nativedroid_server.GenSummaryRequest.so_digest', index=2,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='jni_func', full_name='nativedroid_server.GenSummaryRequest.jni_func', index=3,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='method_signature', full_name='nativedroid_server.GenSummaryRequest.method_signature', index=4,
