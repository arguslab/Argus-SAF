...
import org.argus.jawa.alir.pta.summaryBasedAnalysis.JawaSummaryProvider

/**
  * Created by fgwei on 7/1/17.
  */
class AndroidSummaryProvider(apk: ApkGlobal)(implicit heap: SimHeap) extends JawaSummaryProvider(apk) {
