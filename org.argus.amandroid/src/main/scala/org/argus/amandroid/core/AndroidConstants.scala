...
object AndroidConstants {
  ...
  final val COMPONENTNAME_PACKAGE = "mPackage"
  final val COMPONENTNAME_CLASS = "mClass"

	final val INTENT = "android.content.Intent"
	final val INTENT_COMPONENT = "mComponent"
	final val INTENT_ACTION  = "mAction"
	final val INTENT_MTYPE  = "mType"
  final val URI_STRING_URI = "android.net.Uri$StringUri"
  final val URI_STRING_URI_URI_STRING = "uriString"
	final val INTENT_URI_DATA = "mData"
	final val INTENT_CATEGORIES = "mCategories"
  final val BUNDLE = "android.os.Bundle"
  final val BUNDLE_ENTRIES = "entries"
	final val INTENT_EXTRAS = "mExtras"
	final val INTENT_PACKAGE = "mPackage"
	  
	final val INTENTFILTER = "android.content.IntentFilter"
	final val INTENTFILTER_ACTIONS  = "mActions"
	final val INTENTFILTER_CATEGORIES = "mCategories"
  ...
  final val PROVIDER = "android.content.ContentProvider"
	final val ACTIVITY_INTENT = "mIntent"
