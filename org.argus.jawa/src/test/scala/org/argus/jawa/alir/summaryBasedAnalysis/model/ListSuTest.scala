...
class ListSuTest extends SuTestBase("list.safsu") {
  ...
  "Ljava/util/List;.containsAll:(Ljava/util/Collection;)Z" with_vars (
    Some("temp"), Some("v0"), List("v1")
  ) with_input () produce ()

  "Ljava/util/List;.add:(ILjava/lang/Object;)V" with_vars (
    None, Some("v0"), List("v1", "v2")
  ) with_input (
    thisFact,
  ...
  "Ljava/util/List;.equals:(Ljava/lang/Object;)Z" with_vars (
    Some("temp"), Some("v0"), List("v1")
  ) with_input () produce ()

  "Ljava/util/List;.add:(Ljava/lang/Object;)Z" with_vars (
    Some("temp"), Some("v0"), List("v1")
  ) with_input (
    thisFact,
  ...
  "Ljava/util/List;.addAll:(ILjava/util/Collection;)Z" with_vars (
    Some("temp"), Some("v0"), List("v1", "v2")
  ) with_input (
    thisFact,
    new RFAFact(FieldSlot(thisInstance, "items"), PTAConcreteStringInstance("String", defContext2)),
  ...
  "Ljava/util/List;.hashCode:()I" with_vars (
    Some("temp"), Some("v0"), List()
  ) with_input () produce ()

  "Ljava/util/List;.clear:()V" with_vars (
    None, Some("v0"), List()
  ) with_input (
    thisFact,
    new RFAFact(FieldSlot(thisInstance, "items"), PTAConcreteStringInstance("String", defContext2)),
  ...
  "Ljava/util/List;.contains:(Ljava/lang/Object;)Z" with_vars (
    Some("temp"), Some("v0"), List("v1")
  ) with_input () produce ()

  "Ljava/util/List;.lastIndexOf:(Ljava/lang/Object;)I" with_vars (
    Some("temp"), Some("v0"), List("v1")
  ) with_input () produce ()

  "Ljava/util/List;.remove:(Ljava/lang/Object;)Z" with_vars (
    Some("temp"), Some("v0"), List("v1")
  ) with_input (
    thisFact,
    new RFAFact(FieldSlot(thisInstance, "items"), PTAConcreteStringInstance("String", defContext2)),
  ...
  "Ljava/util/List;.set:(ILjava/lang/Object;)Ljava/lang/Object;" with_vars (
    Some("temp"), Some("v0"), List("v1", "v2")
  ) with_input (
    thisFact,
    new RFAFact(FieldSlot(thisInstance, "items"), PTAConcreteStringInstance("String", defContext2)),
  ...
  "Ljava/util/List;.retainAll:(Ljava/util/Collection;)Z" with_vars (
    Some("temp"), Some("v0"), List("v1")
  ) with_input (
    thisFact,
    new RFAFact(FieldSlot(thisInstance, "items"), PTAConcreteStringInstance("String", defContext2)),
  ...
  "Ljava/util/List;.iterator:()Ljava/util/Iterator;" with_vars (
    Some("temp"), Some("v0"), List()
  ) with_input (
    thisFact,
    new RFAFact(FieldSlot(thisInstance, "items"), PTAConcreteStringInstance("String", defContext2))
  ...
  "Ljava/util/List;.get:(I)Ljava/lang/Object;" with_vars (
    Some("temp"), Some("v0"), List("v1")
  ) with_input (
    thisFact,
    new RFAFact(FieldSlot(thisInstance, "items"), PTAConcreteStringInstance("String", defContext2))
  ...
  "Ljava/util/List;.subList:(II)Ljava/util/List;" with_vars (
    Some("temp"), Some("v0"), List("v1", "v2")
  ) with_input (
    thisFact,
    new RFAFact(FieldSlot(thisInstance, "items"), PTAConcreteStringInstance("String", defContext2))
  ...
  "Ljava/util/List;.listIterator:(I)Ljava/util/ListIterator;" with_vars (
    Some("temp"), Some("v0"), List("v1")
  ) with_input (
    thisFact,
    new RFAFact(FieldSlot(thisInstance, "items"), PTAConcreteStringInstance("String", defContext2))
  ...
  "Ljava/util/List;.isEmpty:()Z" with_vars (
    Some("temp"), Some("v0"), List()
  ) with_input () produce ()

  "Ljava/util/List;.toArray:([Ljava/lang/Object;)[Ljava/lang/Object;" with_vars (
    Some("temp"), Some("v0"), List("v1")
  ) with_input (
    thisFact,
    new RFAFact(FieldSlot(thisInstance, "items"), PTAConcreteStringInstance("String", defContext2))
  ...
  "Ljava/util/List;.listIterator:()Ljava/util/ListIterator;" with_vars (
    Some("temp"), Some("v0"), List()
  ) with_input (
    thisFact,
    new RFAFact(FieldSlot(thisInstance, "items"), PTAConcreteStringInstance("String", defContext2))
  ...
  "Ljava/util/List;.size:()I" with_vars (
    Some("temp"), Some("v0"), List()
  ) with_input () produce ()

  "Ljava/util/List;.indexOf:(Ljava/lang/Object;)I" with_vars (
    Some("temp"), Some("v0"), List("v1")
  ) with_input () produce ()

  "Ljava/util/List;.toArray:()[Ljava/lang/Object;" with_vars (
    Some("temp"), Some("v0"), List()
  ) with_input (
    thisFact,
    new RFAFact(FieldSlot(thisInstance, "items"), PTAConcreteStringInstance("String", defContext2))
  ...
  "Ljava/util/List;.removeAll:(Ljava/util/Collection;)Z" with_vars (
    Some("temp"), Some("v0"), List("v1")
  ) with_input (
    thisFact,
    new RFAFact(FieldSlot(thisInstance, "items"), PTAConcreteStringInstance("String", defContext2)),
  ...
  "Ljava/util/List;.remove:(I)Ljava/lang/Object;" with_vars (
    Some("temp"), Some("v0"), List("v1")
  ) with_input (
    thisFact,
    new RFAFact(FieldSlot(thisInstance, "items"), PTAConcreteStringInstance("String", defContext2))
  ...
  "Ljava/util/List;.addAll:(Ljava/util/Collection;)Z" with_vars (
    Some("temp"), Some("v0"), List("v1")
  ) with_input (
    thisFact,
    new RFAFact(FieldSlot(thisInstance, "items"), PTAConcreteStringInstance("String", defContext2)),
