...
class MapSuTest extends SuTestBase("map.safsu") {
  "Ljava/util/Map;.clear:()V" with_vars (
    None, Some("v0"), List()
  ) with_input (
    ...
    new RFAFact(MapSlot(PTAInstance(new JawaType("java.util.HashMap$Entries"), defContext), PTAConcreteStringInstance("String", defContext2)), PTAConcreteStringInstance("String", defContext3))
  ) produce new RFAFact(VarSlot("v0"), PTAInstance(new JawaType("java.util.HashMap"), defContext))

  "Ljava/util/Map;.clone:()Ljava/lang/Object;" with_vars (
  ...
  "Ljava/util/Map;.entrySet:()Ljava/util/Set;" with_vars (
    Some("temp"), Some("v0"), List()
  ) with_input (
    new RFAFact(VarSlot("v0"), PTAInstance(new JawaType("java.util.HashMap"), defContext)),
    new RFAFact(FieldSlot(PTAInstance(new JawaType("java.util.HashMap"), defContext), "entries"), PTAInstance(new JawaType("java.util.HashMap$Entries"), defContext)),
  ...
  "Ljava/util/Map;.get:(Ljava/lang/Object;)Ljava/lang/Object;" with_vars (
  ...
  "Ljava/util/Map;.keySet:()Ljava/util/Set;" with_vars (
    Some("temp"), Some("v0"), List()
  ) with_input (
    new RFAFact(VarSlot("v0"), PTAInstance(new JawaType("java.util.HashMap"), defContext)),
    new RFAFact(FieldSlot(PTAInstance(new JawaType("java.util.HashMap"), defContext), "entries"), PTAInstance(new JawaType("java.util.HashMap$Entries"), defContext)),
  ...
  "Ljava/util/Map;.put:(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;" with_vars (
    ...
    new RFAFact(MapSlot(PTAInstance(new JawaType("java.util.HashMap$Entries"), defContext), PTAConcreteStringInstance("String", defContext4)), PTAConcreteStringInstance("String", defContext4))
  )

  "Ljava/util/Map;.putAll:(Ljava/util/Map;)V" with_vars (
    None, Some("v0"), List("v1")
  ) with_input (
    new RFAFact(VarSlot("v0"), PTAInstance(new JawaType("java.util.HashMap"), defContext)),
    new RFAFact(FieldSlot(PTAInstance(new JawaType("java.util.HashMap"), defContext), "entries"), PTAInstance(new JawaType("java.util.HashMap$Entries"), defContext)),
    new RFAFact(FieldSlot(PTAInstance(new JawaType("java.util.HashMap$Entries"), defContext), "key"), PTAConcreteStringInstance("String", defContext2)),
  ...
  "Ljava/util/Map;.remove:(Ljava/lang/Object;)Ljava/lang/Object;" with_vars (
    Some("temp"), Some("v0"), List("v1")
  ) with_input (
    new RFAFact(VarSlot("v0"), PTAInstance(new JawaType("java.util.HashMap"), defContext)),
    new RFAFact(FieldSlot(PTAInstance(new JawaType("java.util.HashMap"), defContext), "entries"), PTAInstance(new JawaType("java.util.HashMap$Entries"), defContext)),
  ...
  "Ljava/util/Map;.values:()Ljava/util/Collection;" with_vars (
    Some("temp"), Some("v0"), List()) with_input (
    new RFAFact(VarSlot("v0"), PTAInstance(new JawaType("java.util.HashMap"), defContext)),
    new RFAFact(FieldSlot(PTAInstance(new JawaType("java.util.HashMap"), defContext), "entries"), PTAInstance(new JawaType("java.util.HashMap$Entries"), defContext)),
    new RFAFact(FieldSlot(PTAInstance(new JawaType("java.util.HashMap$Entries"), defContext), "key"), PTAConcreteStringInstance("String", defContext2)),
    new RFAFact(MapSlot(PTAInstance(new JawaType("java.util.HashMap$Entries"), defContext), PTAConcreteStringInstance("String", defContext2)), PTAConcreteStringInstance("String", defContext3))
