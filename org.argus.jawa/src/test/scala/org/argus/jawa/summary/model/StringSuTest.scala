...
class StringSuTest extends SuTestBase("string.safsu") {
  ...
  ) produce new RFAFact(VarSlot("v0"), PTAConcreteStringInstance("", defContext))

  "Ljava/lang/String;.<init>:(II[C)V" with_input (
    new RFAFact(VarSlot("v0"), PTAConcreteStringInstance("", defContext)),
    new RFAFact(VarSlot("v3"), PTAInstance(new JawaType("char[]"), defContext2))
  ) produce (
  ...
  "Ljava/lang/String;.indexAndLength:(I)Ljava/lang/StringIndexOutOfBoundsException;" with_input new RFAFact(VarSlot("v0"), PTAConcreteStringInstance("String", defContext)) produce (
    new RFAFact(VarSlot("v0"), PTAConcreteStringInstance("String", defContext)),
    new RFAFact(VarSlot("temp"), PTAInstance(new JawaType("java.lang.StringIndexOutOfBoundsException"), currentContext))
  )
  ...
  "Ljava/lang/String;.valueOf:(C)Ljava/lang/String;" with_input () produce new RFAFact(VarSlot("temp"), PTAPointStringInstance(currentContext))

  "Ljava/lang/String;.valueOf:(D)Ljava/lang/String;" with_input () produce new RFAFact(VarSlot("temp"), PTAPointStringInstance(currentContext))

  "Ljava/lang/String;.valueOf:(F)Ljava/lang/String;" with_input () produce new RFAFact(VarSlot("temp"), PTAPointStringInstance(currentContext))

  "Ljava/lang/String;.valueOf:(I)Ljava/lang/String;" with_input () produce new RFAFact(VarSlot("temp"), PTAPointStringInstance(currentContext))

  "Ljava/lang/String;.valueOf:(J)Ljava/lang/String;" with_input () produce new RFAFact(VarSlot("temp"), PTAPointStringInstance(currentContext))

  "Ljava/lang/String;.valueOf:(Ljava/lang/Object;)Ljava/lang/String;" with_input () produce new RFAFact(VarSlot("temp"), PTAPointStringInstance(currentContext))

  "Ljava/lang/String;.valueOf:(Z)Ljava/lang/String;" with_input () produce new RFAFact(VarSlot("temp"), PTAPointStringInstance(currentContext))

  "Ljava/lang/String;.valueOf:([C)Ljava/lang/String;" with_input () produce new RFAFact(VarSlot("temp"), PTAPointStringInstance(currentContext))

  "Ljava/lang/String;.valueOf:([CII)Ljava/lang/String;" with_input () produce new RFAFact(VarSlot("temp"), PTAPointStringInstance(currentContext))
